...
describe("quat", function() {
  var mat3 = require("../../src/gl-matrix/mat3");
  var mat4 = require("../../src/gl-matrix/mat4");
  var quat = require("../../src/gl-matrix/quat");
  ...
  describe("slerp", function() {
    ...
    describe("where theta == 180deg", function() {
      beforeEach(function() {
        quat.rotateX(quatA, [1, 0, 0, 0], Math.PI);
  ...
  describe("create", function() {
    ...
    it("should return a 4 element array initialized to an identity quaternion", function() {
      expect(result).toBeEqualish([0, 0, 0, 1]);
    });
  });
  describe("clone", function() {
    ...
    it("should return a 4 element array initialized to the values in quatA", function() {
  ...
  describe("fromValues", function() {
    ...
    it("should return a 4 element array initialized to the values passed", function() {
  ...
  describe("add", function() {
    describe("with a separate output quaternion", function() {
      ...
      it("should not modify quatA", function() {
        expect(quatA).toBeEqualish([1, 2, 3, 4]);
      });
      it("should not modify quatB", function() {
    ...
    describe("when quatA is the output quaternion", function() {
      ...
      it("should place values into quatA", function() {
        expect(quatA).toBeEqualish([6, 8, 10, 12]);
      });
      it("should return quatA", function() {
    ...
    describe("when quatB is the output quaternion", function() {
      ...
      it("should place values into quatB", function() {
        expect(quatB).toBeEqualish([6, 8, 10, 12]);
      });
      it("should return quatB", function() {
  ...
  describe("str", function() {
    ...
    it("should return a string representation of the quaternion", function() {
