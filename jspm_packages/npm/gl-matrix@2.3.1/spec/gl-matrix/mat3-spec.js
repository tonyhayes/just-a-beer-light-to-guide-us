...
describe("mat3", function() {
  ...
  describe("normalFromMat4", function() {
    ...
    describe("with translation and rotation", function() {
      ...
      describe("and scale", function() {
        ...
        it("should give rotated matrix", function() {
          expect(result).toBeEqualish([0.5, 0, 0, 0, 0, 0.333333, 0, -0.25, 0]);
        });
      });
    });
  });
  ...
  describe("create", function() {
    ...
    it("should return a 9 element array initialized to a 3x3 identity matrix", function() {
  ...
  describe("clone", function() {
    ...
    it("should return a 9 element array initialized to the values in matA", function() {
  ...
  describe("multiply", function() {
    it("should have an alias called 'mul'", function() {
      expect(mat3.mul).toEqual(mat3.multiply);
    });
    describe("with a separate output matrix", function() {
      beforeEach(function() {
  ...
  describe("frob", function() {
    ...
    it("should return the Frobenius Norm of the matrix", function() {
      expect(result).toEqual(Math.sqrt(Math.pow(1, 2) + Math.pow(0, 2) + Math.pow(0, 2) + Math.pow(0, 2) + Math.pow(1, 2) + Math.pow(0, 2) + Math.pow(1, 2) + Math.pow(2, 2) + Math.pow(1, 2)));
    });
  });
});
