...
describe("mat2", function() {
  var mat2 = require("../../src/gl-matrix/mat2");
  var out,
      matA,
      matB,
      identity,
  ...
  describe("create", function() {
    ...
    it("should return a 4 element array initialized to a 2x2 identity matrix", function() {
  ...
  describe("clone", function() {
    ...
    it("should return a 4 element array initialized to the values in matA", function() {
